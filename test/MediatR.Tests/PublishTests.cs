...
namespace MediatR.Tests
{
    ...
    public class PublishTests
    {
        ...
        [Fact]
        public async Task Should_resolve_main_handler_for_inherited_message()
        {
            var builder = new StringBuilder();
            var writer = new StringWriter(builder);
            ...
            await mediator.Publish(new Ping2 { Message = "Ping", AdditionalInfo="<>" });
        ...
        [Fact]
        public async Task Should_resolve_main_handler_when_inherited_object_is_passed()
        {
            var builder = new StringBuilder();
            var writer = new StringWriter(builder);
            ...
            object message = new Ping2 { Message = "Ping", AdditionalInfo="<>" };
            await mediator.Publish(message);
