namespace MediatR.Pipeline.Streams
{
    ...
    public interface IStreamRequestExceptionAction<in TRequest, in TException>
    ...
    public interface IStreamRequestExceptionAction<in TRequest> : IStreamRequestExceptionAction<TRequest, Exception>
        where TRequest : notnull
    {
    }
    ...
    /// </summary>
    /// <typeparam name="TRequest">The type of failed request</typeparam>
    public abstract class StreamAsyncRequestExceptionAction<TRequest> : IStreamRequestExceptionAction<TRequest>
        where TRequest : IRequest
    {
        async Task IStreamRequestExceptionAction<TRequest, Exception>.Execute(TRequest request, Exception exception, CancellationToken cancellationToken)
        {
    ...
    /// <typeparam name="TRequest">Request type</typeparam>
    /// <typeparam name="TException">Exception type</typeparam>
    public abstract class StreamRequestExceptionAction<TRequest, TException> : IStreamRequestExceptionAction<TRequest, TException>
        where TRequest : notnull
        where TException : Exception
    {
        Task IStreamRequestExceptionAction<TRequest, TException>.Execute(TRequest request, TException exception, CancellationToken cancellationToken)
        {
    ...
    /// </summary>
    /// <typeparam name="TRequest">Request type</typeparam>
    public abstract class RequestExceptionAction<TRequest> : IStreamRequestExceptionAction<TRequest>
        where TRequest : notnull
    {
        Task IStreamRequestExceptionAction<TRequest, Exception>.Execute(TRequest request, Exception exception, CancellationToken cancellationToken)
        {
            Execute(request, exception);
            return Task.CompletedTask;
        }
