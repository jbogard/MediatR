...
internal sealed class TransientRequestResponseExceptionRequestHandler<TRequest, TResponse, TException> : RequestResponseExceptionRequestHandler
    ...
    where TException : Exception
{
    ...
    private static IRequestResponseExceptionHandler<TRequest, TResponse, TException>? GetHandler(IServiceProvider serviceProvider) =>
        serviceProvider.GetService<IRequestResponseExceptionHandler<TRequest, TResponse, TException>>();
}